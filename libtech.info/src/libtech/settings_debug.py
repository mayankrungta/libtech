...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'templates', 'blog'), # Mynk Get rid off this once class based view
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
PROTECTED_ROOT = os.path.join(os.path.dirname(BASE_DIR), 'CDN', 'protected')
...
if DEBUG:
    ...
    def show_toolbar(request):
        if not request.is_ajax() and request.user and request.user.username == 'mynk':
            return True
        else:
            return False
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = "Try Django Mailer: "
...
# Stripe Stuff
STRIPE_SECRET_KEY = 'sk_test_SVaYJAN0Qf7JXKHHUjN7YNax'
STRIPE_PUBLISHABLE_KEY = 'pk_test_bMz3sZQAUcDO28xSpDtLnpTw'
